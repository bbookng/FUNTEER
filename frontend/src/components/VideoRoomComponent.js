...
const APPLICATION_SERVER_URL = process.env.NODE_ENV === 'production' ? '' : 'https://i8e204.p.ssafy.io/';
        ...
        <div id="layout" className="bounds">
          ...
          {localUser !== undefined && localUser.getStreamManager() !== undefined && (
            <div className="OT_root OT_publisher custom-class" style={chatDisplay}>
              <ChatComponent user={localUser} chatDisplay={this.state.chatDisplay} close={this.toggleChat} messageReceived={this.checkNotification} />
            </div>
          )}
        </div>
      </div>
